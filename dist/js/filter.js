...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Filter.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Filter.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    handleChange: function handleChange(event, label) {
      console.log('hit');
      this.$store.commit("".concat(this.resourceName, "/updateFilterState"), {
        filterClass: this.filterKey,
        value: _objectSpread(_objectSpread({}, this.value), {}, _defineProperty({}, label, event.target.value))
      });
      this.value = _objectSpread(_objectSpread({}, this.value), {}, _defineProperty({}, label, event.target.value));
      this.$emit('change');
    },
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return Nova.request().post("/nova-vendor/filterable-filters/options", {
                model: _this.filter.model,
                values: _this.value,
                filter: _this.filterKey,
                fields: _this.filter.fields
              });
            case 2:
              res = _context.sent;
              _this.options = JSON.parse(JSON.stringify(res.data));
            case 4:
            case "end":
...
Nova.booting(function (Vue, router, store) {
  Vue.component('filterable-filters', (__webpack_require__(/*! ./components/Filter */ "./resources/js/components/Filter.vue")["default"]));
});
    ...
    [
      ...
      _c(
        "p",
        {
          ...
          staticClass: "text-sm text-center uppercase text-80 font-bold pb-2",
        },
        [_vm._v("No available options")]
      ),
      _vm._v(" "),
      _vm._l(_vm.options, function (option) {
        return _c("div", { staticClass: "p-2" }, [
          _c("p", { staticClass: "text-sm uppercase text-80 font-bold pb-2" }, [
          ...
          _c(
            "select",
            {
              ...
              domProps: { value: _vm.value[option.label] },
              on: {
                change: function (event) {
                  return _vm.handleChange(event, option.label)
                },
              },
            },
            [
              ...
              _vm._v(" "),
              _vm._l(option.options, function (option) {
      ...
      _c("div", { staticClass: "px-2" }, [
        _c(
          "button",
          {
            staticClass: "btn btn-default btn-primary w-full mb-2",
            on: {
        ...
        _c(
          "button",
          {
            staticClass: "btn btn-default btn-danger w-full mb-2",
            on: {
              click: function ($event) {
